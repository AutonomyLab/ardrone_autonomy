...
# Assuming a catkin workspace after a `catkin_make` (because we need the patched version of files)
PATH_NAVDATA_KEYS = '../../../build/ardrone/src/ardronelib/ARDroneLib/Soft/Common/navdata_keys.h'
PATH_NAVDATA_COMMON = '../../../build/ardrone/src/ardronelib/ARDroneLib/Soft/Common/navdata_common.h'
...
ros_datatypes = {'uint32_t': ('std_msgs::UInt32', 'uint32_t'),
                 ...
                 'channel' : ('ardrone_autonomy::navdata_gps_channel', 'ardrone_autonomy::navdata_gps_channel')
                 }
